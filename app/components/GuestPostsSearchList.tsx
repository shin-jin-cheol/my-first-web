      ...
      sections={[
        createSearchableListSection({
          ...
          renderItem: (post: GuestPostItem) => {
            ...
            return (
              <ScrollReveal key={String(post.id)}>
                <article className="space-y-3 rounded-2xl border border-border-strong bg-surface-muted p-5 transition hover:bg-surface-strong dark:border-border-sub dark:bg-surface-sub dark:hover:bg-surface-strong">
