  ...
  return (
    <div className="grid gap-8 md:grid-cols-[minmax(0,1fr)_280px]">
      <section className="space-y-5">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-zinc-500 bg-zinc-400/85 dark:border-border-base dark:bg-surface-sub/70 shadow-[0_0_32px_rgba(129,216,208,0.2)] backdrop-blur">
          <HeroImage />
      ...
      <aside className="hidden md:block md:h-full">
        <div className="space-y-4 rounded-2xl border border-zinc-500 bg-surface-muted/92 p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.28),inset_0_-3px_6px_rgba(0,0,0,0.04),0_5px_12px_rgba(0,0,0,0.09)] backdrop-blur-md dark:border-border-base dark:bg-surface-sub/85 dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.07),inset_0_-8px_13px_rgba(0,0,0,0.34),0_7px_16px_rgba(0,0,0,0.28)] lg:h-full">
          ...
          <Link
            href="/posts"
            className="inline-flex w-full items-center justify-center rounded-full border border-zinc-600 bg-surface-strong px-4 py-2.5 text-sm font-semibold text-text-base dark:border-border-base dark:bg-surface-strong dark:text-text-base shadow-[inset_0_1px_0_rgba(255,255,255,0.22),0_0_13px_rgba(129,216,208,0.26)] transition hover:-translate-y-0.5 hover:bg-surface-muted hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.26),0_0_15px_rgba(129,216,208,0.34)]"
          >
            {t(locale, "게시글 목록 열기", "Open Posts")}
          </Link>
          <Link
            href="/posts/new"
            className="inline-flex w-full items-center justify-center rounded-full border border-zinc-600 bg-zinc-400 px-4 py-2.5 text-sm font-semibold text-text-base transition hover:-translate-y-0.5 hover:bg-surface0 dark:border-zinc-600 dark:bg-surface-sub/80 dark:text-text-base dark:hover:bg-surface-strong"
          >
            {t(locale, "새 글 쓰기", "Write New Post")}
          </Link>
          <div className="space-y-2 rounded-xl border border-zinc-500 bg-surface-muted/90 p-3 text-xs leading-6 text-text-sub dark:border-border-base dark:bg-surface-sub/70 dark:text-text-sub">
