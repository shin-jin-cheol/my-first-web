        ...
        <nav className="border-b border-zinc-500 bg-zinc-300 text-zinc-900 shadow-[0_0_30px_rgba(129,216,208,0.22)] dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100 dark:shadow-[0_0_24px_rgba(129,216,208,0.18)]">
          <div className="mx-auto w-full max-w-4xl px-4 py-3 md:px-6 md:py-4">
            ...
            <div className="hidden min-w-0 items-center gap-3 md:flex">
              <span className="inline-flex h-9 min-w-0 flex-1 items-center truncate rounded-full border border-zinc-500 bg-zinc-300/92 px-3 text-base font-extrabold tracking-[0.01em] text-zinc-900 drop-shadow-[0_0_12px_rgba(129,216,208,0.5)] shadow-[inset_0_1px_0_rgba(255,255,255,0.28),inset_0_-3px_6px_rgba(0,0,0,0.04),0_5px_12px_rgba(0,0,0,0.09)] backdrop-blur-md dark:border-zinc-600 dark:bg-zinc-900/70 dark:text-zinc-100 dark:drop-shadow-none dark:shadow-[0_0_14px_rgba(129,216,208,0.35)] md:text-lg lg:max-w-[15rem] lg:flex-none">
                공인재 신진철의 생존일기
              </span>
              <Link href="/" className="hidden h-9 shrink-0 items-center text-sm font-medium text-zinc-700 transition hover:text-zinc-900 hover:drop-shadow-[0_0_12px_rgba(129,216,208,0.6)] dark:text-zinc-300 dark:hover:text-white dark:hover:drop-shadow-[0_0_8px_rgba(129,216,208,0.6)] lg:inline-flex">
                {t(locale, "홈", "Home")}
              </Link>
              <Link href="/posts" className="hidden h-9 shrink-0 items-center text-sm font-medium text-zinc-700 transition hover:text-zinc-900 hover:drop-shadow-[0_0_12px_rgba(129,216,208,0.6)] dark:text-zinc-300 dark:hover:text-white dark:hover:drop-shadow-[0_0_8px_rgba(129,216,208,0.6)] lg:inline-flex">
                {t(locale, "블로그", "Blog")}
              </Link>
              <Link href="/guest" className="hidden h-9 shrink-0 items-center text-sm font-medium text-zinc-700 transition hover:text-zinc-900 hover:drop-shadow-[0_0_12px_rgba(129,216,208,0.6)] dark:text-zinc-300 dark:hover:text-white dark:hover:drop-shadow-[0_0_8px_rgba(129,216,208,0.6)] lg:inline-flex">
              ...
              {session?.role === "owner" ? (
                <Link href="/admin/members" className="hidden h-9 shrink-0 items-center text-sm font-medium text-zinc-700 transition hover:text-zinc-900 dark:text-zinc-300 dark:hover:text-white xl:inline-flex">
                  {t(locale, "회원관리", "Members")}
                </Link>
              ) : null}
              {session?.role === "member" ? (
                <Link href="/guest/account" className="hidden h-9 shrink-0 items-center text-sm font-medium text-zinc-700 transition hover:text-zinc-900 dark:text-zinc-300 dark:hover:text-white xl:inline-flex">
                  {t(locale, "회원정보", "Account")}
                </Link>
              ) : null}
              {session ? (
                <span className="hidden h-9 shrink-0 items-center rounded-full border border-cyan-600/45 bg-cyan-500/12 px-3 text-xs font-semibold uppercase tracking-wide text-[#2f8f88] shadow-[0_0_10px_rgba(129,216,208,0.35)] dark:border-cyan-500/40 dark:bg-cyan-500/10 dark:text-cyan-200 dark:shadow-none xl:inline-flex">
                  {session.role}
                </span>
              ) : null}
