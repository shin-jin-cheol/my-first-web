  ...
  return (
    <section className="space-y-8">
      <header className="space-y-2">
        ...
        <h1 className="text-4xl font-extrabold text-zinc-100">회원 계정 관리</h1>
        <p className="text-zinc-300">주인 계정에서 회원 아이디/비밀번호를 조회할 수 있습니다.</p>
      </header>

      <div className="rounded-2xl border border-zinc-700 bg-zinc-800 p-5">
        <p className="text-sm text-zinc-300">주인 계정</p>
